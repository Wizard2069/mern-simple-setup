...
export class ProductRepository extends Repository<Product> {
    ...
    async createProduct(createProductDto: CreateProductDto): Promise<Product> {
        const {_id, name, price, list_price, rating_average, review_count, description, category, image_url, link, summary_description} = createProductDto;
        ...
        product.summary_description = summary_description;
